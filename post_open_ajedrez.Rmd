...
dfpaths <- df_all_movements %>% filter(num_ply == c(1, 3, 5)) %>%
...
* TODO: Enseñar la foto de los primeros movimientos. (primer movimiento de las blancas, primer movimiento de las negras)
